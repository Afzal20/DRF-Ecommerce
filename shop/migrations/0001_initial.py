# Generated by Django 5.2.3 on 2025-08-21 04:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtotal', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=50)),
                ('tax_percentage', models.DecimalField(decimal_places=5, default=Decimal('0.085'), max_digits=10)),
                ('tax_total', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=50)),
                ('total', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=50)),
